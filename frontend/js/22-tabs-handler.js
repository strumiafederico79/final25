 ...
 *   #pasoArchivo / #pasoCadena / #pasoSalida
 *   #projects-section
 */
(function () {
  'use strict';
  ...
  function selectTabInternal(tabName) {
    const normalized = VALID_TABS.has(tabName) ? tabName : 'pane-archivo';
  ...
  function initTabs() {
    ...
    selectTabInternal(VALID_TABS.has(saved) ? saved : 'pane-archivo');
  }
